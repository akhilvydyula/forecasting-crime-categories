# Contributing to CrimeCast - Forecasting Crime Categories

Thank you for helping improve **CrimeCast - Forecasting Crime Categories**! This project is part of the
...
```bash
git clone https://github.com/akhilvydyula/forecasting-crime-categories.git
...
- [GitHub Discussions](https://github.com/akhilvydyula/forecasting-crime-categories/discussions) for Q&A
