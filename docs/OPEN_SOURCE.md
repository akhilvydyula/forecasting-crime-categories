...
Open-source features enabled for **CrimeCast - Forecasting Crime Categories**.
...
| Tech stack | Python, Streamlit, SITAKA API, scikit-learn, Plotly, Mapbox |
...
| Discussions | [GitHub Discussions](https://github.com/akhilvydyula/forecasting-crime-categories/discussions) |
...
3. Open or pick an [issue](https://github.com/akhilvydyula/forecasting-crime-categories/issues)
