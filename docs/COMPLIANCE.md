...
Legal, ethical, and data-handling expectations for **CrimeCast - Forecasting Crime Categories**.
...
| Source | Notes |
|--------|-------|
| Primary dataset | Kaggle CrimeCast competition data - subject to competition rules |
